...
class _AccountCardState extends State<AccountCard> {
  ...
  void _copyContext() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('📋 Context copied to clipboard!'), backgroundColor: Color(0xFF00FF88), duration: Duration(seconds: 2)),
    );
  }
        ...
        child: Column(children: [
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(acc.nickname, style: TextStyle(color: c, fontSize: 16, fontWeight: FontWeight.bold, fontFamily: 'monospace')),
                if (acc.projectDescription.isNotEmpty)
                  Text(acc.projectDescription, style: const TextStyle(color: Colors.grey, fontSize: 11)),
              ])),
              Container(
                ...
                child: Text(acc.status, style: TextStyle(color: c, fontSize: 11, fontWeight: FontWeight.bold, fontFamily: 'monospace')),
              ),
            ]),
          ),
          ...
          Padding(
            ...
            child: Column(children: [
              Text(
                ...
                style: TextStyle(
                  color: c, fontSize: acc.isReady ? 20 : 40,
          ...
          Padding(
            ...
            child: Column(children: [
              // Open buttons
              Row(children: [
                Expanded(child: _btn('🔲 In App', const Color(0xFF4499FF), () => _openInApp(ctx))),
  ...
  void _openInApp(BuildContext ctx) {
    _copyContext();
    Navigator.pushNamed(ctx, '/webview', arguments: widget.account);
  }
